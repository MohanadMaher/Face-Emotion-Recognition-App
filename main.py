...
def welocme_page():
    ...
    root.title('Emotion Tracker and Dectector')
    ...
    Label(root, text='Welcome, home! ', bg='#F0F8FF', font=('courier', 20, 'bold')).place(x=201, y=34)

    Label(root, text='Username:', bg='#F0F8FF', font=('arial', 12, 'normal')).place(x=152, y=237)

    Label(root, text='Password: ', bg='#F0F8FF', font=('arial', 12, 'normal')).place(x=152, y=277)
    ...
    Button(root, text='Login', bg='#0000EE', font=('arial', 12, 'normal'), command=lambda : emotion_detect()).place(x=282, y=327)

    Button(root, text='Create New Account', bg='#7FFF00', font=('arial', 12, 'normal'), command=lambda : signup_page()).place(x=232, y=377)
    root.mainloop()
            ...
            if np.sum([roi_gray]) != 0:
                ...
                if current == 'Happy':
                    ...
                    if counter_H == 5:
                        counter_H = 0
                        def Continue():
                            webbrowser.open_new_tab('https://www.youtube.com/watch?v=_bFK36Hylts')
                        def cancel():
                            root.destroy()
                        ...
                        # This is the section of code which creates a button
                        Button(root, text='Continue', bg='#7FFF00', font=('arial', 14, 'normal'),command=lambda :Continue()).place(x=71, y=240)
                ...
                if current == 'Sad':
                    ...
                    if counter_S == 5:
                        counter_S = 0
                        def Continue():
                            webbrowser.open_new_tab('https://www.youtube.com/watch?v=Y2NkuFIlLEo&list=PLgzTt0k8mXzHcKebL8d0uYHfawiARhQja')
                        def cancel():
                            root.destroy()
                ...
                if current == 'Angry':
                    ...
                    if counter_A == 5:
                        counter_A = 0
                        def Continue():
                            webbrowser.open_new_tab('https://www.youtube.com/watch?v=lFcSrYw-ARY')
                        def cancel():
                            root.destroy()
                        ...
                        # This is the section of code which creates the a label
                        Label(root, text='Why youre angry tho?', bg='#F0F8FF', font=('arial', 12, 'normal')).place(x=132, y=34)
